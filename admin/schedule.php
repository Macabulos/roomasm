...
<tbody>
            ...
            <td align="center">
                ...
                <div class="modal fade" id="deleteModal<?php echo $row['schedule_id']; ?>" tabindex="-1" role="dialog">
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <a class="btn btn-danger" href="delete_schedule.php?id=<?php echo $row['schedule_id']; ?>">
                                    Yes, Delete
                                </a>
